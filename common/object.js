...
function deepClone(obj) {
  var recordKey = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
  ...
  if ((typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) === 'object' && obj !== null) {
    ...
    keys.forEach(function (val) {
      ...
      //为防止数据绑定中的特殊数据导致无限循环
      if (recordKey[val] && recordKey[val].indexOf(obj[val]) !== -1 && _typeof(obj[val]) === 'object' && obj[val] !== null) {
        return;
      }
...
function setAttr(obj, key, data) {
  ...
  (function getLevel(model, modelKey, writeKey) {
    ...
    //检查对象
    if (_typeof(model[modelKey]) !== 'object' || model[modelKey] === null) {
...
var classExtends = function classExtends(a, b) {
...
exports.default = {
  ...
  findBoolanProperties: findBoolanProperties
};