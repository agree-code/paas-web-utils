...
exports.CONTENT_TYPE = exports.VIEW_ENUM = exports.COLUMN_ENUM = exports.CONDITION_TYPE = exports.formatDate = undefined;
...
var CONDITION_TYPE = exports.CONDITION_TYPE = {
  EQ: {
    label: "等于",
    value: 3
  },
...
var COLUMN_ENUM = exports.COLUMN_ENUM = {
  TEXT_INPUT: {
    val: "input",
    text: "文本输入框",
    placeholder: function placeholder(label) {
      return "\u8BF7\u8F93\u5165" + label;
    },
    full: false
  },
  ...
  DEPT_SELECT: {
    ...
    format: function format(val) {
      var showVals = _organization2.default.loadSycnShowVal(val) || [];
...
var VIEW_ENUM = exports.VIEW_ENUM = {
  INSERT: {
    value: "INSERT",
    class: _insertView2.default
  },
  EDIT: {
    value: "EDIT",
    class: _editView2.default
  },
  DETAIL: {
    value: "DETAIL",
    class: _detailView2.default
  },
  LIST: {
    value: "LIST",
    class: _listView2.default
  },
  BATCH_UPDATE: {},
  CUSTOM: {
    value: "CUSTOM",
    class: _view2.default
  }
};
